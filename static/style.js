...
export default css.global`
  ...
  * {
  ...
  .land-see-subscribe-form input[type='email'] {
    font: 600 0.8125rem/2.0625 Inconsolata, verdana, sans-serif;
    letter-spacing: 0.6px;
    border: 2px solid #fff;
    padding: 2px 0 0 0.688rem;
  }
  ...
  .land-see .amp-carousel-button {
    ...
    background: transparent
      url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='16' height='32' viewBox='0 0 16 32' overflow='visible'%3E%3Cpath fill='none' stroke='%23DFDFDF' stroke-miterlimit='10' d='M.354 31.201l15.423-15.424L.354.354'/%3E%3C/svg%3E")
      no-repeat 50%;
  }
  ...
  .land-see-categories-button {
    font: 500 0.9375rem/1.11111 Inconsolata, verdana, sans-serif;
    text-transform: uppercase;
  ...
  .land-see-blockquote:before {
    content: '';
    background: url(../../img/land-see/structure/green-up-full-20.svg) 0 0/198px
      156px no-repeat;
    position: absolute;
    top: 50%;
    left: 1rem;
